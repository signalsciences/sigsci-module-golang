...
docker run  -v ${PWD}/goroot:/go/ --rm golang-git:1.10.6-alpine3.8 /bin/sh -c ' go get github.com/tinylib/msgp && go get github.com/alecthomas/gometalinter && go get github.com/signalsciences/tlstext'
